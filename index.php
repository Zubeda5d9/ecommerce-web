...
background: linear-gradient(0deg, rgba(7,123,125,1) 10%, rgba(18,21,122,1) 58%);color:white">
    <center>
        ...
        <div class="col-md-6">
            ...
            <input type="text" name="name" class="form-control" id="productName" style="width: 400px; color: black;">

        </div>
        <div class="col-md-6">
            <label for="productPrice" class="form-label">Enter Product Price:</label>
            <input type="text" name="price" class="form-control" id="productPrice" style="width: 400px; color: black;">

        </div>
        <div class="col-12">
            <label for="productImage" class="form-label">Image:</label>
            <input type="file" name="image" class="form-control" id="productImage" style="width: 400px; color: black;">
        </div>
        <div class="col-12">
